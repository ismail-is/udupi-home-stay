                            ...
                            <div className="row">
                                ...
                                <div className="col col-xl-4 col-lg-6 col-md-6 col-12">
                                    <div className="office-info-item">
                                        ...
                                        <div className="office-info-text">
                                            <h2>Email Us</h2>
                                         <p><a href='mailto:fahad@udupistay.com' style={{color:"#595959"}}>fahad@udupistay.com</a></p>   
                                ...
                                <div className="col col-xl-4 col-lg-6 col-md-6 col-12">
                                    <div className="office-info-item">
                                        ...
                                        <div className="office-info-text">
                                            <h2>Call Now</h2>
                                           <p> <a href='https://wa.me/918971220576 ' style={{color:"#595959"}}>+91 89712 20576  </a></p>
                                            <a href='tel:+9180501 23132 ' style={{color:"#595959"}}>+91 80501 23132  </a>
